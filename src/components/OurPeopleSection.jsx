...
const LEADERSHIP_DATA = [
  {
    ...
    role: 'FOUNDER / CEO',
    bio: '“AI UpShift is our mission to ensure that talent, not geography, defines who participates in the AI economy.”',
  ...
  },
  {
    ...
    name: 'K. SPANDANA',
    role: 'CO-FOUNDER',
    bio: '“AI UpShift bridges the gap between AI capability and economic opportunity by turning skills into proof, and proof into possibilities.”',
...
const MENTORS_DATA = [
  ...
  },
  {
    ...
    linkedin: 'https://www.linkedin.com/in/vijay-kumar-jakkula-a1a4b130/',
  },
  {
    id: 'mentor-3',
    label: 'MENTOR 03',
